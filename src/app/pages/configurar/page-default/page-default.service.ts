...
export class PageDefaultService {
 ...
 //private readonly API_RENAN = 'http://10.173.5.18:8080/rest/api/v1/SchemaConv/'; //Chamando o endereço direto da API
  private readonly API_RENAN = 'http://localhost:1322/rest/api/v1/SchemaConv/'; //Chamando o endereço direto da API
  ...
  post( jsonTSSNewNFse: PageDefault ){

    console.log(jsonTSSNewNFse);
    return this.http.post(`${this.API_RENAN}${this.endPontPOST}`, jsonTSSNewNFse).pipe(take(1));
