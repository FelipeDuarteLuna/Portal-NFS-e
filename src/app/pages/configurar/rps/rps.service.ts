...
export class RpsService {
  ...
  //private readonly API = 'http://localhost:3000/tssNewNfse'; Chamando o endereÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§o direto da API
  //private readonly API = environment.API; //Quando o endereÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§o for http://localhost:3000/tssNewNfse
  private readonly API = `${environment.API}tssNewNfse`;
  private readonly API_RENAN = 'http://10.173.5.18:8080/rest/api/v1/SchemaConv/'; //Chamando o endereÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§o direto da API
